  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden">
        <div className="flex flex-col items-center w-full h-screen pt-48 lg:pt-48 pb-0">
          <div className="text-center">
            <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
              Realtor
            </h1>
            <p className="mt-3 text-xl text-muted-foreground">
              Vyhledejte vaší vysněnou nemovitost
            </p>
                ...
                <div className="relative z-10 flex space-x-3 p-3 border bg-background rounded-lg shadow-lg">
                  <div className="flex-[1_0_0%]">
                    ...
                    <Input
                      ...
                      className="h-full"
                      id="article"
                      placeholder="pronájem Praha-4 44m2 2+kk do 40 000 kč"
                    />
                  </div>
