...
class Listing:
    def __init__(self, msg: Dict): 
        ...
        logging.info(self.transaction)  
        # GPS coordinates (latitude and longitude only)
        self.gps = self.extract_gps(data)

        # Extract city and city part
        self.city,self.city_part,self.street,self.full_address = self.extract_city_info(data)
    ...
    def extract_city_info(self, data):
        ...
        return  city_name, city_part, street, full_address
